      ...
      <footer className="bg-black text-white border-t-4 border-black">
        <div className="container mx-auto px-6 py-8 max-w-7xl flex justify-between items-center">
          ...
          <div className="flex gap-6">
            <Link href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#7DF9FF] transition-colors">
              <Twitter size={24} />
            </Link>
            <Link href="https://reactpad.gitbook.io/" target="_blank" rel="noopener noreferrer" className="hover:text-[#7DF9FF] transition-colors">
              <BookOpen size={24} />
            </Link>
            <Link href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#7DF9FF] transition-colors">
              <GitMerge size={24} />
            </Link>
          </div>
        </div>
