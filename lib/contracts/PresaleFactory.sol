...
contract PresaleFactory {
    ...
    event PresaleCreated(
        address indexed creator, address indexed presale, address indexed saleToken, address paymentToken
    );
    ...
    function createPresale(CreateParams calldata params) external returns (address presale) {
        ...
        presale = address(new LaunchpadPresale(IERC20(params.saleToken), params.paymentToken, params.config, owner));
